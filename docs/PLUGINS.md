...
`import type { OrganizerPlugin } from '@pablojustdevs/file-organizer-cli'` now works via the
...
```typescript
// my-plugin.ts
import type { OrganizerPlugin } from '@pablojustdevs/file-organizer-cli';
...
```typescript
import { Organizer } from '@pablojustdevs/file-organizer-cli';
...
starts the CLI. The binary lives at `@pablojustdevs/file-organizer-cli/bin`
